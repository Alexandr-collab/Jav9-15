                ...
                <table class="table">
                    ...
                    <c:forEach var="ord" items="${orderDetails}">
                        <tr>
                            ...
                            <td width="20"><a href="<c:url value="/editorderdetail?id=${ord.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Редактировать"
                                     src="img/edit.png"></a>
                            </td>
                            <td width="20"><a href="<c:url value="/deleteorderdetail?id=${ord.getId()}" />" role="button"
                                              class="btn btn-outline-primary">
                                <img alt="Удалить"
                                     src="img/delete.png" onclick="return confirm('Удалить детали заказа с ID: ' + ${ord.getId()} + '?')"></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
